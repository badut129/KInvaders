...
class CollisionAABB(val player: GameObject, val protagonists: ArrayList<GameObject>, val neutral: ArrayList<GameObject>, val antagonist: ArrayList<GameObject>) : ICollisionHandler {
